...
var display = document.querySelector("#timer");                 //Timer when quiz starts
...
var questions , option1, option2, option3 ,option4 ,ans, previousScores;
...
for(var i = 0 ; i < 4 ; i++){
    ...
    ch.setAttribute("class","btn btn-dark d-grid gap-2 col-6 mx-auto rounded-pill mb-2");
    choiceArray.push(ch);
    divArray.push(dv);
}
...
result.setAttribute("class","text-muted ");
...
function startTimer(duration, display) {
    ...
    var timeInterval =  setInterval(function () {
        ...
        if (--time < 0 || (questionIndex > totalQuestions-1)) {
            time = duration;
...
function viewResult(){  
    ...
    form.setAttribute("class","d-grid gap-2 col-6 mx-auto");
    ...
    text.setAttribute("class","ml-3 form-control");

    var scoreButton = document.createElement("button");     //Submit User score
    scoreButton.setAttribute("class","d-grid gap-2 col-12 mx-auto btn btn-dark rounded-pill mb-2 ml-3 mt-2");
...
function showHighScores(){
    ...
    questionEl.setAttribute("class","text-center text-dark");
    questionEl.style.display = "block";
    ...
    scoreDiv.style.display = "none";
        ...
        heading1.setAttribute("class","bg-light");
        ...
        heading2.setAttribute("class","bg-light");
    ...
    goback.setAttribute("class","btn btn-dark d-grid gap-2 col-6 mx-auto rounded-pill mb-2 mt-4 ml-2");
    ...
    clearscores.setAttribute("class","btn btn-dark d-grid gap-2 col-6 mx-auto rounded-pill mb-2 mt-4 ml-2");
